...
# Grab the catalog and schema names from environment variables
# In the pipeline, these are set from Terraform outputs
catalog_name = os.getenv("CATALOG_NAME", "trial_dbt")
